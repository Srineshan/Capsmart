...
const ValidationDialog = ({ getIsOpen, labelList }) => {
    return (
            ...
            <div>
                <div className={Classes.DIALOG_BODY}>
                    <div className={style.spaceBetween}>
                        <div className={style.heading}>Validation Alert!</div>
                    ...
                    <div className={`${style.justifyCenter} ${style.displayInRow} ${style.marginTop}`}>
                        ...
                        <div className={`${style.continue} ${style.marginLeft}`} onClick={() => { getIsOpen(false); }}>SKIP</div>
                    </div>
                </div>
