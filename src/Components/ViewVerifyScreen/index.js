            ...
            <div>
              <div>
                ...
                {form?.forms?.[formIndex]?.data?.isModulesForReAppointmentCompleted?.response !== undefined && (
                  <div className={`${style.markedAsText} ${style.marginTop20}`}><strong>Marked as <span className={form?.forms?.[formIndex]?.data?.isModulesForReAppointmentCompleted?.response === 'Yes' ? style.yesText : style.noText}>{form?.forms?.[formIndex]?.data?.isModulesForReAppointmentCompleted?.response}</span></strong> on {form?.forms?.[formIndex]?.data?.isModulesForReAppointmentCompleted?.date !== '' ? format(new Date(form?.forms?.[formIndex]?.data?.isModulesForReAppointmentCompleted?.date), "MMM dd, yyyy") : ''}</div>
                )}
              </div>
              <div className={`${style.marginTop20}`}>
                <div className={style.cardTitle}>
                ...
                {form?.forms?.[formIndex]?.data?.doYouPrescribeSuboxone?.response !== undefined && (
                  <div className={`${style.markedAsText} ${style.marginTop20}`}><strong>Marked as <span className={form?.forms?.[formIndex]?.data?.doYouPrescribeSuboxone?.response === 'Yes' ? style.yesText : style.noText}>{form?.forms?.[formIndex]?.data?.doYouPrescribeSuboxone?.response}</span></strong> on {form?.forms?.[formIndex]?.data?.doYouPrescribeSuboxone?.date !== '' ? format(new Date(form?.forms?.[formIndex]?.data?.doYouPrescribeSuboxone?.date), "MMM dd, yyyy") : ''}</div>
                )}
              </div>
              {(form?.basicDetails?.departmentSpecialty?.department === 'Women & Children' && form?.basicDetails?.departmentSpecialty?.specialty === 'Pediatrics') && (
                <div className={`${style.marginTop20}`}>
                  ...
                  {form?.forms?.[formIndex]?.data?.wishToBeMRP?.response !== undefined && (
                    <div className={`${style.markedAsText} ${style.marginTop20}`}><strong>Marked as <span className={form?.forms?.[formIndex]?.data?.wishToBeMRP?.response === 'Yes' ? style.yesText : style.noText}>{form?.forms?.[formIndex]?.data?.wishToBeMRP?.response}</span></strong> on {form?.forms?.[formIndex]?.data?.wishToBeMRP?.date !== '' ? format(new Date(form?.forms?.[formIndex]?.data?.wishToBeMRP?.date), "MMM dd, yyyy") : ''}</div>
                  )}
                </div>
              )}
