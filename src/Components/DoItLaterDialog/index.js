        ...
        <Dialog isOpen={getIsOpen} onClose={() => getIsOpen(false)} className={`${style.eSignDialog} ${style.eSignDialogBackground}`} canOutsideClickClose={false} canEscapeKeyClose={false}>
            <div>
                <div className={Classes.DIALOG_BODY}>
                    ...
                    <p className={`${style.description} ${style.marginTop}`}>No problem! You can start your {window.location.pathname.includes("applicationForm") ? 'Appointment' : 'Reappointment'} application anytime you're ready by clicking the link in the original email you received.</p>
