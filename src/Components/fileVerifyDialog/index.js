...
const FileVerifyDialog = ({ getIsOpen, file, fileArray, selectedFileIndex, setSelectedFileIndex,selectedRowTableName,selectedFormId,setForm }) => {
            ...
            <div>
                <div className={Classes.DIALOG_BODY}>
                    ...
                    <div className={` ${style.threeColGrid} ${style.centerALign} ${style.titleBackgroundColorStyle} ${style.marginTop}`}>
                        ...
                        {/* <div className={`${style.heading}`}>Document  1 of 2</div> */}
