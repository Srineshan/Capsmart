...
const Navbar = () => {
  ...
  const logoutURL = () => {
    window.location.href = `http://ec2-35-161-12-67.us-west-2.compute.amazonaws.com:8010/logout`;
  }
  ...
  const logout = async () => {
    ...
    // await fetch(`http://ec2-35-161-12-67.us-west-2.compute.amazonaws.com:8010/logout`, {
    //   // redirect: 'manual',
    //   method: 'PUT',
    //   body: JSON.stringify({}),
    // }).then(response => {
    ...
    // await axios(`http://ec2-35-161-12-67.us-west-2.compute.amazonaws.com:8010/logout`, {
    //   method: 'PUT',
    //   data,
    // }).then(response => {
    //   const logouturi = response.headers.get('location') || '';
    ...
    // axios.post(`http://ec2-35-161-12-67.us-west-2.compute.amazonaws.com:8010/logout`, {
    //   // Add parameters here
