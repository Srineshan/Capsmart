        ...
        <div className={style.navbarStyle}>
            <div className={style.spaceBetween}>
                <div className={style.displayInRow}>
                    ...
                    {isEntityLevelAdmin && (
                        <div>
                            <div className={`${style.menuStyle} ${(window.location.pathname === "/user" || window.location.pathname === "/welcome" || window.location.pathname === "/partnerPortal") && style.activeMenuColor}`}
                                ...
                                >
                                    <div className={style.optionsCardStyle}>
                                        ...
                                        <Link to={isSuperAdminAccess ? '/partnerPortal' : '/welcome'} className={style.noFontStyle}>
