...
const TileStaff = ({
  ...
  return (
    <div
      className={`${style.cardStyle} ${selectedApplicant === currentTile && style.selectedApplicantBackground
        }`}
      ...
      <div className={style.spaceBetweenColumn}>
        ...
        <div className={`${style.spaceBetween} ${style.marginBottom5} `}>
          <div className={`${style.displayInColRev}`}>
            ...
            >
              <div
                className={`${style.headingCountForContracts} ${(window.location.pathname.includes("/entitySitePortal") && selectedApplicant === currentTile) ? style.purple : ''} ${bigNumber !== "-" ? bigNumberColor : ""
          ...
          >
            {smallNum3 !== "" && (
              ...
              >
                {(smallTextSelected === smallText3 && selectedApplicant === currentTile) && (<ClearIcon sx={{ fontSize: 13, color: '#7165E3', marginRight: '10px' }} onClick={() => setSmallTextSelected('')} />)}
                <Tooltip title={`Click here to apply ${smallText3} filter`} arrow
                  ...
                  <span className={(smallTextSelected === smallText3 && selectedApplicant === currentTile) ? style.smallTextSelected : ''} onClick={() => handleSmallTextSelected(smallText3)}>{smallText3}</span>
                </Tooltip>
                <span
                  className={`${smallNum3 !== "-"
                    ? selectedApplicant === currentTile
                      ? smallNum3SelectedColor
                      : smallNum3Color
            ...
            {smallNum1 !== "" && (
              <span className={`${style.verticalAlignCenter} ${style.marginTop5} ${style.alignRight}`} >
                {(smallTextSelected === smallText1 && selectedApplicant === currentTile) && (<ClearIcon sx={{ fontSize: 13, color: '#7165E3', marginRight: '10px' }} onClick={() => setSmallTextSelected('')} />)}
                <Tooltip title={`Click here to apply ${smallText1} filter`} arrow
                  ...
                  <span className={(smallTextSelected === smallText1 && selectedApplicant === currentTile) ? style.smallTextSelected : ''} onClick={() => handleSmallTextSelected(smallText1)}>{smallText1}</span>
                </Tooltip>
                <span
                  className={`${smallNum1 !== "-"
                    ? selectedApplicant === currentTile
            ...
            {smallNum2 !== "" && (
              ...
              >
                {(smallTextSelected === smallText2 && selectedApplicant === currentTile) && (<ClearIcon sx={{ fontSize: 13, color: '#7165E3', marginRight: '10px' }} onClick={() => setSmallTextSelected('')} />)}
                <Tooltip title={`Click here to apply ${smallText2} filter`} arrow
                  ...
                  <span className={(smallTextSelected === smallText2 && selectedApplicant === currentTile) ? style.smallTextSelected : ''} onClick={() => handleSmallTextSelected(smallText2)}>{smallText2}</span>
                </Tooltip>
                <span
                  className={`${smallNum2 !== "-"
                    ? selectedApplicant === currentTile
