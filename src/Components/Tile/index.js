      ...
      <div className={style.spaceBetweenColumn}>
        ...
        <div className={`${style.spaceBetween}`}>
          <div className={style.displayInColRev}>
            ...
            <div className={style.displayInRow}>
              <p className={`${style.headingCountForContracts} ${bigNumber !== '-' ? bigNumberColor : ''}`}>{bigNumber}</p>
          ...
          <div className={`${style.optionsStyle} ${style.displayInCol} ${style.reduceTop20} ${style.alignRight}`}>
            {smallNum1 !== '' && (
              <span className={`${style.verticalAlignCenter} ${style.alignRight}`}>{smallText1}<span className={`${smallNum2 !== '-' ? selectedContract === currentTile ? smallNum1SelectedColor : smallNum1Color : style.defaultSmallNumber} ${style.countDesign}`}>{smallNum1}</span></span>
            )}
            {smallNum2 !== '' && (
              <span className={`${style.verticalAlignCenter} ${style.marginTop5} ${style.alignRight}`}>{smallText2}<span className={`${smallNum2 !== '-' ? selectedContract === currentTile ? smallNum2SelectedColor : smallNum2Color : style.defaultSmallNumber} ${style.countDesign}`}>{smallNum2}</span></span>
            )}
          </div>
        </div>
      </div>
