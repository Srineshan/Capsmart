...
const TableTwo = ({
  ...
  return (
    <div>
      <div>
        <div
          className={`${style.tableHeader} ${gridStyle} ${style.marginTop10}`}
        >
            ...
            >
              {data === "CHECKBOX" ? (
                <img
                  src={Checkbox}
                  alt=""
                  className={`${style.CheckboxImgStyle} ${style.marginLeft30}`}
                />
              ) : data === "POD Icon" ? (
                <img
                  src={PODIcon}
                  alt=""
                  className={`${style.CheckboxImgStyle}`}
                />
                ...
                <div
                  className={`${data === "" && style.marginLeft30} ${
                    style.tableHeaderFontStyle
                  }`}
                >
                  {data}
                </div>
              )}
              {
                ...
                data === availableSortValue[sortValue?.sortByField] &&
                sortValue?.sortBy === "ASCENDING" ? (
                  <img
                    src={AscendingSort}
                    alt=""
                    className={`${style.sortImgStyle} ${style.cursorPointer}`}
                    onClick={() =>
                      getHandleSort(availableSortValueEnum[data], "ASCENDING")
                    }
                  />
                ) : tableSortValues?.[index] &&
                  data === availableSortValue[sortValue?.sortByField] &&
                  sortValue?.sortBy === "DESCENDING" ? (
                  <img
                    src={DescendingSort}
                    alt=""
                    className={`${style.sortImgStyle} ${style.cursorPointer}`}
                    onClick={() =>
                      getHandleSort(availableSortValueEnum[data], "DESCENDING")
                    }
                  />
                ) : (
                  tableSortValues?.[index] && (
                    <img
                      ...
                      className={`${style.sortImgStyle} ${style.cursorPointer}`}
                      onClick={() =>
                        getHandleSort(availableSortValueEnum[data], "NONE")
                      }
                    />
                  )
                )
              ...
              <>
                ...
                >
                  {tableDataValues?.map((tableData, tableDataIndex) =>
                    tableData?.type === "dot" ? (
                      <div
                        className={`${style.displayInRow} ${style.justifySpaceAround} ${style.verticalAlignCenter}`}
                      >
                        <Tooltip title={tableData?.tooltipValue?.[index]} arrow>
                          <div
                            className={`${
                              tableData?.value?.[index] === "green"
                                ? style.green
                                : tableData?.value?.[index] === "yellow"
                                ? style.yellow
                                : tableData?.value?.[index] === "grey"
                                ? style.grey
                                : tableData?.value?.[index] === "red"
                                ? style.red
                                : ""
                            } ${
                              tableData?.value?.[index] === "green"
                                ...
                                : tableData?.value?.[index] === "grey"
                                ? style.greyDotStyle
                                : tableData?.value?.[index] === "purple"
                                ? style.purpleDotStyle
                                : ""
                            }`}
                          ></div>
                        </Tooltip>
                      ...
                      <div
                        className={`${style.displayInRow} ${style.marginLeft30} ${style.verticalAlignCenter}`}
                      >
                      ...
                      <p
                        className={`${style.tableDataFontStyle} ${style.cursorPointer} ${style.verticalAlignCenter}`}
                        onClick={
                          tableData?.onClickFunction
                            ? () => {
                                tableData?.onClickFunction(data, index);
                              }
                            : () => {}
                        }
                      >
                      ...
                      <div>
                        <p
                          className={`${style.tableDataFontStyle} ${style.cursorPointer} ${style.verticalAlignCenter}`}
                          onMouseEnter={(e) =>
                            handleClickTextWithHover(e, index, tableDataIndex)
                          }
                      ...
                      <div>
                        <p
                          className={`${style.tableDataFontStyle} ${style.cursorPointer} ${style.verticalAlignCenter}`}
                          onMouseEnter={(e) =>
                            handleClickCountWithHover(e, index, tableDataIndex)
                          }
                        ...
                        <div className={style.popoverStyle}>
                          ...
                          >
                            ...
                            {tableData?.hoverText?.[index]?.map(
                              (data, innerIndex) => (
                                <div
                                  className={style.multipleOptionsCard}
                                  ref={countHoverRef}
                                >
                                  <div
                                    className={`${style.specificActionCard} ${style.cursorPointer}`}
                      ...
                      <div
                        onMouseEnter={(e) =>
                          handleClickIconWithCount(e, index, tableDataIndex)
                        }
                        onMouseLeave={() => handleCloseIconWithCount()}
                        aria-owns={
                          openIconWithCount ? "mouse-over-popover" : undefined
                        }
                        aria-haspopup="true"
                      >
                        <Typography
                          className={`${style.displayInRow} ${style.cursorPointer} ${style.verticalAlignCenter}`}
                        >
                          {tableData?.icon?.[index]}
                          <p
                            className={`${style.tableDataFontStyle} ${style.marginTop10} ${style.marginLeft5}`}
                          >
                            {tableData?.value?.[index]}
                          </p>
                      ...
                      <div
                        onMouseEnter={(e) =>
                          handleClickIcon(e, index, tableDataIndex)
                        }
                      ...
                      >
                        <Typography
                          className={`${style.cursorPointer} ${style.verticalAlignCenter} ${style.fullWidth}`}
                        >
                          {tableData?.icon?.[index]}
                          {tableData?.isShowHoverText &&
                            index === selectedMenuIndex &&
                      ...
                      tableData?.value?.[index]?.length !== 0 ? (
                        <div
                          className={`${style.displayInRow} ${style.cursorPointer} ${style.verticalAlignCenter}`}
                          onMouseEnter={(e) =>
                            handleClickSite(e, index, tableDataIndex)
                          }
                          onMouseLeave={() => handleCloseSite()}
                          aria-owns={
                            openSite ? "mouse-over-popover" : undefined
                          }
                          aria-haspopup="true"
                        >
                          <Typography
                          ...
                          >
                            ...
                            {index === selectedMenuIndex &&
                              ...
                              tableData?.value?.[index] !== "-" && (
                                ...
                                >
                                  <div className={style.actionsCard}>
                                    {tableData?.value?.[index]?.map(
                                      (siteData, siteIndex) => (
                                        <div
                                          className={`${style.siteCard} ${style.cursorPointer}`}
                                          key={siteIndex}
                                        >
                      ...
                      tableData?.value?.[index]?.length !== 0 ? (
                        <div
                          className={`${style.displayInRow} ${style.cursorPointer} ${style.verticalAlignCenter}`}
                          onMouseEnter={(e) =>
                            handleClickDept(e, index, tableDataIndex)
                          }
                          onMouseLeave={() => handleCloseDept()}
                          aria-owns={
                            openDept ? "mouse-over-popover" : undefined
                          }
                          aria-haspopup="true"
                        >
                          <p
                                    ...
                                    {tableData?.value?.[index]?.map(
                                      (siteData, siteIndex) => (
                                        <>
                                          ...
                                          {siteData?.departmentList?.departments?.map(
                                            (deptData, deptIndex) => (
                                              <div
                                                className={`${style.deptCard} ${style.cursorPointer}`}
                                                key={deptIndex}
                                              >
                                                {deptData?.departmentName?.name}
                                              </div>
                                            )
                                          )}
                                        </>
                      ...
                      <div
                        ...
                        onClick={
                          actions[0]?.conditionToShow !== undefined &&
                          actions?.length === 1
                            ? eval(actions[0]?.conditionToShow)
                              ? () => {
                                  setShowOptions(true);
                                  setSelectedMenuIndex(index);
                                }
                          ...
                          >
                            ...
                            <div className={style.actionsCard} ref={menuRef}>
                              {actions?.map((actionsData, actionsIndex) =>
                                actionsData?.isParagraph ? (
                                  <>
                                    <div className={`${style.divider}`}></div>
                                    <div
                                      className={`${style.isParagraph}`}
                                      key={actionsIndex}
                                    >
                                      {" "}
                                      {actionsData.data}{" "}
                                ...
                                ) : actionsData?.conditionToShow !==
                                  undefined ? (
                                  eval(actionsData?.conditionToShow) && (
                                    <div
                                      className={`${style.specificActionCard} ${
                                        style.cursorPointer
                                      } ${
                                        actionsData?.isIndent
                                          ? style.marginLeft30
                                          : ""
                                      }`}
                                      onClick={() => {
        ...
        {!hidePagination && (totalCount || tableData?.length) > 10 && (
          <Pagination
            ...
            totalCount={totalCount || tableData?.length}
            selectedPage={page || 1}
          />
        )}
      </div>
