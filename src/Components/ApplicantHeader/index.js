        ...
        <div className={`${style.headerCard}`}>
            <div className={`${style.gridCol}`}>
                ...
                <div className={style.icons}>
                    ...
                    <div className={`${style.backgroundLogo} ${style.cursorPointer} ${style.verticalAlignCenter} ${style.justifyCenter}`} onClick={handleLogout}>
                        <Tooltip title={"Click To Logout"} arrow><LogoutOutlinedIcon sx={{ fontSize: 18, color: "#52575D" }} /></Tooltip></div>
                </div>
            </div>
        </div>
    )
