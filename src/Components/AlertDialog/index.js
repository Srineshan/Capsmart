            ...
            <div>
                <div className={Classes.DIALOG_BODY}>
                    ...
                    <div className={`${style.justifyCenter} ${style.displayInRow} ${style.marginTop}`}>
                        <div className={`${style.saveInProgress}`} onClick={() => { getIsOpen(false, 'CANCEL'); }}>CANCEL</div>
                        <div className={`${style.continue} ${style.marginLeft}`} onClick={() => { getIsOpen(false, 'OKAY'); }}>CONFIRM</div>
                    </div>
                </div>
