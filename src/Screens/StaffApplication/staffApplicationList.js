...
const StaffApplicationList = ({
  ...
  const departmentHeadHeaderValues = applicationType === "NEW" ? [
    "",
    "Applicant Name",
    "Applicant ID",
    "Applicant Type",
  ...
  const departmentHeadColSortValues = applicationType === "NEW"  ? [
    false,
    true,
    true,
    true,
  ...
  const getDepartmentHeadValues = applicationType === "NEW" ? () => {
    dot = [];
    applicantName = [];
    applicantId = [];
    applicantType = [];
