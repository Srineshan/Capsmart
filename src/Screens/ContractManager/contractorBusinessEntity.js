        ...
        <div className={style.cloneBlockStyle}>
            <div className={`${style.newContractFromCloneBoxStyle}`}>
                ...
                <div className={`${style.extentionGrid} ${style.marginTop20}`}>
                    ...
                    <div className={style.twoCol}>
                        <InputGroup className={style.fullWidth} value={businessEntityUser?.name?.firstName}
                        ...
                        <InputGroup className={style.fullWidth} value={businessEntityUser?.name?.lastName}
                ...
                <div className={`${style.extentionGrid} ${style.marginTop20}`}>
                    ...
                    <InputGroup className={style.fullWidth}  value={businessEntityUser?.email?.officialEmail}
                ...
                <div className={`${style.extentionGrid} ${style.marginTop20}`}>
                    ...
                    <div className={style.twoCol}>
                        <InputGroup className={style.fullWidth} value={businessEntityUser?.contactNumber?.number}
                ...
                <div className={`${style.extentionGrid} ${style.marginTop20}`}>
                    ...
                    <div>
                        <InputGroup className={style.fullWidth} value={mailingAddress?.addressLine}
                        onChange={(e) => setMailingAddress({...mailingAddress, addressLine: e.target.value})} />
                        <div className={`${style.grid3} ${style.marginTop10}`}>
                            <InputGroup className={style.fullWidth} value={mailingAddress?.city}
                        onChange={(e) => setMailingAddress({...mailingAddress, city: e.target.value})} />
                            <InputGroup className={style.fullWidth}  value={mailingAddress?.state}
                        onChange={(e) => setMailingAddress({...mailingAddress, state: e.target.value})} />
                            <InputGroup className={style.fullWidth}  value={mailingAddress?.zipcode}
