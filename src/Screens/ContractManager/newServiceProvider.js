...
const NewServiceProvider = ({
  ...
  return (
    <Dialog
      isOpen={getNewServiceProviderDialog}
      onClose={() => getNewServiceProviderDialog(false)}
      ...
      >
        <div className={style.spaceBetween}>
          ...
          <Icon
            ...
            onClick={() => getNewServiceProviderDialog(false)}
          />
        </div>
          ...
          <div className={`${style.extentionGrid} ${style.marginTop20}`}>
            ...
            <div className={style.displayInRow}>
              <CommonSwitch
                ...
                onChange={(e) => setAllowPersonalMail(!allowPersonalMail)}
              />
              {allowPersonalMail && (
                <div
