          ...
          <div className={`${style.documentGrid}`}>
            <a href={fileFields?.[i]?.filePath} target="_blank">
              <Tooltip title={"Preview"} arrow>
                <ArticleOutlinedIcon
                  sx={{ color: "#b0a9ef", fontSize: 35 }}
                  onClick={() => {
                    setSelectedFileURL(fileFields?.[i]?.filePath);
                  }}
                />
              </Tooltip>
            </a>
            <div className={style.marginTop}>
              <a href={fileFields?.[i]?.filePath} target="_blank">
                <Tooltip title={"Preview"} arrow>
                  ...
                  >
                    <strong>{fileFields?.[i]?.type}</strong>
                  </p>
                </Tooltip>
              </a>
        ...
        <div className={style.cloneBlockStyle}>
          <div
            className={`${style.contractEntityCardStyle} ${
              style.contractEntityFontStyle
            } ${contractId !== "" ? style.completedEntityCardStyle : ""} ${
