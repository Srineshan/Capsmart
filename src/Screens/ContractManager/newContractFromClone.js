...
const NewContractFromClone = ({getNewContract}) => {
    ...
    console.log(selectContractManager);
        ...
        <div className={`${style.welcomePadding} ${style.addContractBody}`}>
            <div className={style.spaceBetween}>
                ...
                <select
                    ...
                    className={`${style.textFieldWidth} ${style.marginLeft20} ${style.reduceTop10} ${style.marginBottom}`}>
            ...
            <div className={style.newContractFromCloneGrid}>
                <div className={style.cloneBlockStyle}>
                    <div className={`${style.contractEntityCardStyle} ${style.contractEntityFontStyle} ${style.selectedContractEntityStyle}`}>
                ...
                <div className={style.cloneBlockStyle}>
                    ...
                    <div className={`${style.floatRight} ${style.marginTop20}`}>
                        ...
                        <button className={`${style.buttonStyle} ${style.marginLeft20}`} onClick={()=>getShowAlertDialog(true)}>CONTINUE</button>
                    </div>
                </div>
                <div className={style.cloneBlockStyle}>
            ...
            {showAlertDialog && (
              <Alert getShowAlertDialog={getShowAlertDialog} />
            )}
        </div>
    )
}
