  ...
  return (
    <div>
      <div className={`${style.addManagerGrid} ${style.marginTop20}`}>
        <CommonLabel
          value="Dedicated Hours For Supplemental Services*"
          className={
            dataCheck(metadata?.dedicatedHoursSpecified) ? style.redLable : ""
          }
        />
          ...
          {!metadata?.dedicatedHoursSpecified && (
            <FormControl sx={{ width: 480 }}>
              <CommonSelectField
                ...
                firstOptionLabel={"Select source of hours for this service"}
                firstOptionValue={""}
