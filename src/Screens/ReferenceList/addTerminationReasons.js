      ...
      >
        ...
        <div className={`${style.addHealthCareBoxStyle}`}>
          ...
          <div className={`${style.extentionGrid} ${style.marginTop20}`}>
            ...
            >
              <FormControlLabel
                control={<Switch defaultChecked className={classes.switch} />}
                label="Yes"
              />
              <div className={`${style.displayInRow} ${style.inputBoxStyle}`}>
                <div className={`${style.displayInCol} ${style.inputBoxStyle}`}>
                  <label
                    htmlFor="notice"
                  ...
                  <InputGroup
                    ...
                    rightElement={
                      <span className={`${style.rightElementText} `}>Days</span>
                    }
                  />
                </div>
                <div className={`${style.displayInCol} ${style.inputBoxStyle}`}>
