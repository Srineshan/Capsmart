...
const addContractedServicesForHealthcare = ({getAddContractedServicesDialog}) => {
    ...
    const [dropType, setDropType] = useState('Dropdown');
    ...
    return(
        <Dialog isOpen={getAddContractedServicesDialog} onClose={() => getAddContractedServicesDialog(false)} className={`${style.healthCarePodDialogStyle} ${style.dialogPaddingBottom}`}>
          <div className={`${Classes.DIALOG_BODY} ${style.extensionDialogBackground}`}>
            <div className={style.spaceBetween}>
                <p className={style.dialogTitleStyle}>ADD / EDIT CONTRACTED SERVICES FOR HEALTHCARE</p>
                <div className={style.displayInRow}>
                    ...
                    <Icon icon="cross" size={20} intent={Intent.DANGER} className={`${style.dialogCrossStyle} ${style.marginLeft20}`} onClick={() => getAddContractedServicesDialog(false)}  />
                </div>
            </div>
            <div className={style.ReferenceListEntityBorder}></div>
            <div className={`${style.podGrid} ${style.marginTop20}`}>
                <div className={style.extentionLableStyle}>INDUSTRY TYPE*</div>
                <select
                    name="class"
                    id="Class"
            ...
            <div className={`${style.podGrid} ${style.marginTop20}`}>
                <div className={style.extentionLableStyle}>CONTRACTED ACTIVITY CATEGORY NAME*</div>
                <div className={style.displayInRow}>
                <select
                    name="class"
                    id="Class"
                ...
                <div className={style.displayInRow}>
                <div className={`${style.activeRadioStyle} ${style.marginTop} ${style.spaceBetween}`}></div>
                <div className={`${style.radioTextStyle} ${style.marginLeft10} ${style.marginTop}`}>ACTIVITY TO PERFORM</div>
                </div> 
                </div>
                </div>
            <div className={`${style.podGrid} ${style.marginTop20}`}>
                <div className={style.extentionLableStyle}>ACTIVITY TO PERFORM*</div>
                <select
                    name="class"
                    id="Class"
                    className={`${style.halfWidth}`}>
...
export default addContractedServicesForHealthcare;