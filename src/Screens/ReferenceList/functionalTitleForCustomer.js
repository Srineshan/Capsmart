...
const FunctionalTitleForCustomer = () => {
    ...
    return (
        <Fragment>
                                    ...
                                    <div className={style.customersAdminColumngrid1}>
                                        <div>
                                            ...
                                            <div className={style.customersAdminCardStyle1}>
                                                <div className={`${style.boardCertificationSideRows1} ${style.displayInRow}`}>
                                                    ...
                                                    <p className={`${style.tableHeaderIndustriesFontStyle} ${style.marginLeft10}`}>DENTAL PROFESSIONAL</p>
                                        ...
                                        <div>
                                            ...
                                            <div className={style.customersAdminCardStyle3}  >
                                                ...
                                                <p className={style.holidayScheduleCardtextStyle1} onClick={() => getAddFunctionalTitlesDialog(true)}>
            ...
            {showFunctionalTitlesDialog && <AddFunctionalTitlesForCustomer getAddFunctionalTitlesDialog={getAddFunctionalTitlesDialog} />}
        </Fragment>
    )
}
