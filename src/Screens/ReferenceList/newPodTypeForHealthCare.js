...
const NewPodTypeForHealthcare = ({ getAddEntityDialog }) => {
    ...
    return (
        <Dialog isOpen={getAddEntityDialog} onClose={() => getAddEntityDialog(false)} className={`${style.healthCarePodDialogStyle} ${style.dialogPaddingBottom}`}>
            <div className={`${Classes.DIALOG_BODY} ${style.extensionDialogBackground}`}>
                <div className={style.spaceBetween}>
                    ...
                    <div className={style.displayInRow}>
                        ...
                        <Icon icon="cross" size={20} intent={Intent.DANGER} className={`${style.dialogCrossStyle} ${style.marginLeft20}`} onClick={() => getAddEntityDialog(false)} />
                    </div>
                </div>
