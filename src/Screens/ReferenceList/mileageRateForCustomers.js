                    ...
                    <div className={style.customersAdminColumngrid3}>
                      ...
                      <div>
                        ...
                        <div className={style.customersAdminCardStyle3}>
                          <div className={`${style.ContractedServiceProviderHeaderInsideContainer1} ${style.displayInRow}`}>       
                            <p></p>
                          ...
                          </div>
                          {
                            mileageRateData?.map((data,index)=>{
                              return (
                                ...
                                <div>
                                  <div
                                    className={`${style.ContractedServiceProviderHeaderInsideContainer1} ${style.displayInRow}`} key={index}
                                  >
                                    <p></p>
                                    <p
