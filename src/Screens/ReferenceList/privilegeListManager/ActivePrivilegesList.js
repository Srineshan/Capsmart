...
const ActivePrivilegesList = ({
  ...
  const getTableDataValues = () => {
    if (selectedTab === "permanentStaff") {
      return tableData.map((data) => ({
        ...
        privilegeTitle: data.privilegeTitle,
  ...
  useEffect(() => {
    const tableDataValues = getTableDataValues();
        ...
        <div className={`${style.bigCardStyle}`}>
          {isLoading ? (
            ...
            <div ref={componentRef}>
              ...
              >
                <TableTwo
                  tableHeaderValues={getTableHeaderValues()}
...
//       <div>
//         <div
//           className={`${style.displayInRow} ${style.spaceBetween} ${style.headingForStaffs} ${style.bottomTextStyle} ${style.marginTop10}`}
//         >
