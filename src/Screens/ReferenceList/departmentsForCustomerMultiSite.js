...
const DepartmentsForCustomersMultiSite = () => {
    ...
    return (
        <Fragment>
                                            ...
                                            <div className={style.margin20}>
                                                <div className={style.customersAdminColumngrid1}>
                                                    <div>
                                                        ...
                                                        <div className={style.customersAdminCardStyle1}>
                                                            <div className={`${style.boardCertificationSideRows1} ${style.displayInRow}`}>
                                                                ...
                                                                <p className={`${style.TextStyle3} ${style.marginLeft10}`}>ARIZONA METROPOLITAN HOSPITAL ( ACUTE CA... ) </p>
                                                    ...
                                                    <div className={style.customersAdminCardStyle2} >
                                                        ...
                                                        <img src={SelectArrow} className={`${style.colorFileStyle4}`} onClick={() => { setIsSelected(true); getAddDepartmentforHealthcareDialog(true) }} />
                                                    </div>
                                                    <div>
            ...
            {showAdddepartmentForHealthcareDialog && <AddDepartmentAreaForBannerHealthcare getAddDepartmentforHealthcareDialog={getAddDepartmentforHealthcareDialog} />}
