            ...
            <div className={`${Classes.DIALOG_BODY} ${style.extensionDialogBackground}`}>
                ...
                <div className={`${style.addHealthCareBoxStyle}`}>
                    <div className={`${style.editHealthCareGrid2}`}>
                        ...
                        <div className={style.displayInRow}>
                            <InputGroup value="Healthcare" className={style.width150} rightElement={arrowDown()} />
                        </div>
                    </div>
                    <div className={`${style.editHealthCareGrid2} ${style.marginTop20}`}>
                        <div className={style.entityLableStyle}>Entity / Site Type*</div>
                        <div className={style.displayInRow}>
                            <InputGroup value="Hospital / Acute Care Facility (ACF)" className={style.width150} rightElement={arrowDown()} />
                        </div>
                    </div>
                    <div className={`${style.editHealthCareGrid2} ${style.marginTop20}`}>
                        <div className={style.entityLableStyle}>Contracted Service Provide Type*</div> 
                        <div className={style.displayInRow}>
                            <InputGroup value="Physician / Doctor" className={style.width150} rightElement={arrowDown()} />
                        </div>
                    </div>
                    ...
                    <div className={`${style.addHealthCareBoxStyle}`}>
                        <div className={`${style.editHealthCareGrid2}`}>
                            ...
                            <InputGroup value="Anesthesiologist" className={style.fullWidth} />
                        </div>
                        <div className={`${style.editFunctionalTitlesGrid} ${style.marginTop20}`}>
                            ...
                            <InputGroup value="Alias 2" className={`${style.fullWidth}`} />
                        </div>
                    </div>
                ...
                <div>
                    <div className={`${style.floatRight} ${style.marginTop20}`}>
                        ...
                        <button onClick={() => getAddFunctionalTitlesDialog(false)} className={`${style.buttonStyle} ${style.marginLeft20}`}>SAVE & CLOSE</button>
                    </div>
                </div>
            </div>
        </Dialog>
