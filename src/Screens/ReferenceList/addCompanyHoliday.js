            ...
            <div className={`${Classes.DIALOG_BODY} ${style.extensionDialogBackground}`}>
                ...
                <div className={`${style.addHealthCareBoxStyle}`}>
                    ...
                    <div className={`${style.editHealthCareGrid2} ${style.marginTop20}`}>
                        ...
                        <div className={style.displayInRow}>
                            <InputGroup value={stateName} className={style.halfWidth} onChange={(e) => setStateName(e.target.value)} />
                        </div>
                    </div>
                    ...
                    <div className={`${style.addHealthCareBoxStyle}`}>
                        <div className={`${style.editHealthCareGrid2}`}>
                            ...
                            <div className={style.displayInRow}>
                                <InputGroup value={eventName} className={style.fullWidth} onChange={(e) => setEventName(e.target.value)} />
                            </div>
                        </div>
