...
const AddContractedServiceByIndustries = ({
  getAddEntityDialog,
  selectedTitle,
  IndustryId,
  seletedEntity,
      ...
      >
        <div className={style.spaceBetween}>
          <p className={style.extensionStyle}>
            ADD CONTRACTED SERVICES BY HEALTHCARE
          </p>
          <Icon
            icon="cross"
            size={20}
        ...
        <div className={`${style.addHealthCareBoxStyle}`}>
          <div className={`${style.editHealthCareGrid1} ${style.marginTop20}`}>
            ...
            <div className={style.displayInRow}>
              ...
              <input
                className={`${style.marginLeft10} ${style.marginTop} ${style.StyledCheckbox}`}
...
export default AddContractedServiceByIndustries;
