        ...
        <Fragment>
            ...
            <div className={style.margin20}>
                ...
                >
                    ...
                    <div>
                        <LevelTwoHeader
                            heading={`CONTRACT TYPE BY INDUSTRIES`}
                                    ...
                                    <div className={style.departmentCardColumnsGrid}>
                                        ...
                                        <div className={style.industriesEntityCardStyle}>
                                            <div className={style.tableHeaderSuffixByIndustries}>
                                                ...
                                                >
                                                    {`CONTRACT TYPE FOR ${selectedTitle}`}
                                                </p>
            ...
            {showDeleteConfirmation && (
                <DeleteConfirmation
                    ...
                    confirmationText="Do you want to delete this Contract Type?"
                />
            )}
        </Fragment>
    );
...
export default ContractByTndustries;
