...
const ReleaseNotes = ({ getSelectedHelp }) => {
    ...
    const getAddReleaseNotesDialog = (value) => {
        setShowAddReleaseNotesDialog(value);
    }
            ...
            {releaseNote2 ? (
                <div className={style.margin20}>
                    ...
                    <div className={`${style.grid5} ${style.marginTop20}`}>
                        ...
                        <div className={`${style.cardStyle} ${style.selectedCardBackground}`} onClick={() => getSelectedHelp('RELEASE NOTES')}>
                        ...
                        <div className={style.bigCardStyle}>
                            <div className={style.spaceBetween}>
                                ...
                                <div className={`${style.displayInRow} ${style.marginTop20}`}>
                                    ...
                                    <button className={style.tutorialButton} onClick={() => getAddReleaseNotesDialog(true)}>ADD REALEASE NOTE</button>
                                </div>
                            </div>
                                ...
                                <div>
                                    <div className={`${style.collapseHeader} ${style.marginTop20} ${style.spaceBetween}`}>
                                        <div className={style.displayInRow}>
                                            ...
                                            <div className={`${style.greenDotFeedbackStyle} ${style.marginLeft20}`}></div>
                                        </div>
                                        <div className={style.displayInRow}>
                    ...
                    {showAddReleaseNotesDialog && <AddReleaseNotes getAddReleaseNotesDialog={getAddReleaseNotesDialog} />}
                </div>
            ) : (
                <div className={style.margin20}>
                    <div className={style.bigCardGrid}>
