...
import { userTimeZone, siteTimeZone } from '../../utils/formatting';
    ...
    return (
        <Fragment>
            ...
            <div className={`${isExpanded ? style.bigCardGrid : style.smallCardGrid} ${style.margin20}`}>
                ...
                <div>
                    <LevelTwoHeader heading={'HELP MANAGEMENT'} updatedTime={`UPDATED ON ${formatInTimeZone(new Date(), siteTimeZone !== 'undefined' ? siteTimeZone : userTimeZone, 'MMM d, yyyy H:mm')}`} hideClose={true} />
                    ...
                    {selectedOption !== "FAQS" ? (
                        <div className={`${style.bigCardStyle} ${style.marginTop20}`}>
                            <div className={style.spaceBetween}>
                                <p className={`${style.activeContractsWidth}`}>{formatInTimeZone(new Date(), siteTimeZone !== 'undefined' ? siteTimeZone : userTimeZone, 'MMM d, yyyy H:mm')}</p>
