...
const PNPManager = () => {
  ...
  return step1 ? (
    <PNPManagerStep1 setStep1={setStep1} setStep2={setStep2} mdFile={mdFile} getMD={getMD} mdValue={mdValue} setMdValue={setMdValue} setSelectedMdId={setSelectedMdId} />
  ) : step2 ? (
    <PNPManagerStep2 setStep1={setStep1} setStep3={setStep3} setStep2={setStep2} mdValue={mdValue} getMD={getMD} setMdValue={setMdValue} setSelectedMdId={setSelectedMdId} />
  ) : step3 ? (
