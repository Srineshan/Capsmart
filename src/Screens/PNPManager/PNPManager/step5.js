...
const PNPManagerStep5 = ({ setStep4, setStep5, mdValue, setMdValue, setSelectedMdId }) => {
        ...
        <div className={style.stepsBackground}>
            <div className={`${style.stepHeader} ${style.spaceBetween} ${style.verticalAlignCenter}`}>
                <div className={style.displayInRow}>
                    <div className={`${style.stepNumber} ${style.marginLeft10}`}>Step 5</div>
                ...
                <div className={style.displayInRow}>
                    <div className={`${style.spaceBetween}`}>
                        <Tooltip arrow title='Click to go Back'>
                            <button className={`${style.buttonStyleMd} ${style.marginRight} `} onClick={() => { setStep4(true); setStep5(false) }} >BACK</button>
                        </Tooltip>
                        ...
                        <Tooltip arrow title='Click to Continue'>
                            <button className={`${style.buttonStyleMd} ${style.marginRight} `} onClick={() => { signOffExists ? setStep5(false) : setIsConfirmationDialog(true) }} >CONTINUE</button>
                        </Tooltip>
                    </div>
                </div>
            </div>
...
export default PNPManagerStep5;