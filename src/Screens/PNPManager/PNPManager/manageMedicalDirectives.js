...
const ManagePNP = ({ getSelectedOption, setStep1, setStep2, setStep3, setStep4, setMdFile, advancedSearch, setSelectedMdId, showAddNewMedicalDirectives, setShowAddNewMedicalDirectives }) => {
