    ...
    return (
        <div className={style.screenBackground}>
            <div className={style.welcomeText}>
                <ApplicationHeader title={`${policyAndProcedures?.title ? `${policyAndProcedures?.pnpID} : ${policyAndProcedures?.title}` : ''}`} close={true} closeClick={handleClose} isNotLogout={true} />
            </div>
