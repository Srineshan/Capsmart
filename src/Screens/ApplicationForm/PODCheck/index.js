...
const PODCheck = ({ basicForm, setBasicForm, applicationId }) => {
  ...
  const itemsToProcessConditionCheckCategories = [
    "Education",
    "WorkExperience",
    "References",
  ];
  ...
  return (
    <div className={style.screenBackground}>
      ...
      <div className={style.screenPadding}>
        <div className={`${style.applicationScreenGrid} ${style.marginTop}`}>
          <div className={`${style.applicationCardStyle}  ${style.marginTop}`}>
            <div className={`${style.displayInRow}${style.marginTop20}`}>
              ...
              >
                <span className={`${style.tableHeaderHeadingTextStyle}`}>
                  Overall Status Of Data & Documents Required For This
                  Application
                </span>
            ...
            <div
              className={` ${style.marginTop10} ${style.tableHeaderGridStyle} `}
            >
              <div></div>
              <div
              ...
              >
                <div
                  className={
                    form?.forms.every((item) => item.acknowledged === true)
                      ? style.greenDotStyle
            ...
            >
              ...
              >
                <div
                  className={`${style.tableHeaderTextStyle} ${style.marginLeft20}`}
                >
                  POD Verification Check
                </div>
              </div>
              <div
                className={`${style.displayInRow} ${style.verticalAlignCenter} `}
            ...
            <div
              className={`${style.tableDataStyle} ${style.marginTop5} ${style.tableValueGridStyle} `}
            >
              <div
                className={`${style.displayInRow} ${style.verticalAlignCenter} `}
              >
                <div
                  className={`${style.marginLeft5} ${style.tableDataFontDisabledStyle1}}`}
                ></div>
              </div>
              <div
                className={`${style.displayInRow} ${style.verticalAlignCenter} `}
                ...
                ?.map((data, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <img
                        ...
                        onClick={() => {
                          sessionStorage.setItem("fromSummary", true);
                          navigate(
                            `/applicationForm/section1/${data?.title
                              ?.toLowerCase()
                              ?.replace(" ", "")}`
                          );
                        }}
                    ...
                    >
                      ...
                      <div
                        className={`${
                          form?.forms[index]?.acknowledged === true
                            ? style.greenDotStyle
                            : style.yellowDotStyle
                        }`}
                      ></div>
                    ...
                    >
                      <div
                        className={`${style.marginLeft5} ${style.tableDataFontDisabledStyle1}`}
                      >
                        {itemsToProcessConditionCheckCategories?.includes(
                          form?.forms?.filter(
                            (data) => data?.formCategory === "Form"
                          )[index]?.schemaCategory
                        ) && form?.forms[index]?.unFilledFields?.length !== 0
                          ? "Missing mandatory fields. Please complete."
      ...
      {isDialogOpen && (
        <PodCheckDialog onClose={() => setIsDialogOpen(false)} />
      )}
    </div>
  );
};
