...
// const AcknowledgementStep9 = ({ acknowledgementForm, dateFormat, name, basicForm, getPreApplication, applicationId }) => {
//     const [isChecked, setIsChecked] = useState(false);
//     const navigate = useNavigate()
//     const targetRef = useRef();
//     const [pdfUrl, setPdfUrl] = useState("https://development-application-mgmt-service.s3.us-east-1.amazonaws.com/PACS_Req_Fillable.pdf");
...
//         try {
//             const { data: profile } = await GET(`application-management-service/application/${applicationId}/profile`);
//             return profile;
//         } catch (error) {
...
//           if ( profileData) {
//               const existingPdfBytes = await fetch(pdfUrl,{ mode: "no-cors" }).then((res) => res.arrayBuffer());
...
//               // Populate the fields with profile data
//               form.getTextField("Text35").setText(`${lastName} ${firstName}`);
...
//               form.getTextField("Text145").setImage(profileData.esignature?.sign|| "")
//               form.getTextField("Text144").setText(currentDate() || "");
//               form.getTextField("Text145").setImage(profileData.esignature?.sign|| "")
//               form.getTextField("Text150").setText(currentDate() || "");
  
//               // Serialize the modified PDF
//               const pdfBytes = await pdfDoc.save();
//               const blob = new Blob([pdfBytes], { type: 'application/pdf' });
//               const pdfUrllink = URL.createObjectURL(blob);
//               setPdfUrl(pdfUrllink)
//               await addNewDocument(blob);
//           }
//       } catch (error) {
//           console.error('Error populating PDF fields:', error);
//       }
//   };
...
// export default AcknowledgementStep9;
