    ...
    return (
        <div>
            <div className={style.applicationScreenGrid}>
                <ProgressCard step={'STEP 5'} dataType={''} title={formSchema?.title} timeNumber={16} timeText={'Min'} progressStyle={`${style.progressStyle} ${style.progressStyleBackground}`} />
            ...
            <div className={`${style.applicationScreenGrid} ${style.marginTop}`}>
                ...
                <div>
                    ...
                    <div className={`${style.continue} ${style.marginTop10}`} onClick={() => navigate('/applicationForm/section1/step8')} >CONTINUE</div>
