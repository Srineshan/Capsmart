...
const LocumStaffTiles = ({ getSelectedTab, selectedTab, reFetchMetaData, setReFetchMetaData, locumCount, locumexpireCount, locumTempPrivilegeCount, totalRequestCount }) => {
