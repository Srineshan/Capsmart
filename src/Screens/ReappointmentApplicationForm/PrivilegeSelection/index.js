            ...
            {!isEdit && (
              <>
                ...
                <div>
                    ...
                    <div className={`${style.stickyContainer} ${isSaveInProgressOpen || showPaymentDialog || showJourneyDialog ||
                        showPrivileges || showCurrentPrivileges || isAlertOpen || isOpen ? style.hiddenStickyContainer: ""}`}>
