...
const Login = (props) => {
  ...
  //   await axios(`http:${window.location.hostname}/entity-service/entityID`, {
  //     method: "GET",
  ...
  const getLogo = async () => {
    ...
    setLogo({
      logo: data?.logo?.file?.fileURL,
      title: data?.entityName?.entityName,
    });
  };
  ...
  //   };
  //   fetch(
  //     `http:${window.location.hostname}/user-management-service/auth/login`,
  //     requestOptions
  //   )
    ...
    <div className={`${style.loginGrid} ${style.loginBackground}`}>
      <div className={style.welcomeImgCardStyle}>
        <img
          src={WelcomeImg}
          alt="WelcomeImg"
          className={style.welcomeImgStyle}
        />
        <div className={`${style.headingStyle} ${style.marginTop50}`}>
      ...
      <div className={style.padding100}>
        ...
        <div className={style.marginTop30}>
          <div>
            <span className={style.timeTextStyle}>Time</span>
            <span className={style.smartTextStyle}>Smart.AI</span>
          </div>
        </div>
        <div>
        ...
        <div
          className={`${style.regHeading} ${style.blackText} ${style.marginTop50}`}
        >
        ...
        <Link to={"/setPassword/:userId"}>
          <div className={`${style.setPasswordStyle} ${style.marginTop30}`}>
