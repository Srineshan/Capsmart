    ...
    return (
        <div className={style.welcomeBackground}>
            ...
            <div className={style.welcomeContentMargin}>
                ...
                <div className={`${style.accountTypeStyle} ${style.fontColorBlack}`}>Contract Account</div>
                ...
                <div className={`${style.spaceBetween} ${style.welcomeDescription} ${style.marginTop20} ${style.fontColorBlack}`}>
