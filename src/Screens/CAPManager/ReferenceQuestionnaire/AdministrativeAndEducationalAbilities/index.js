...
const AdministrativeAndEducationalAbilities = ({ referenceForm, setReferenceForm, applicationId, getReferenceDetails, formSchema, formIndex, formSchemaWholeObject, getAllPath, getAllLabels }) => {
    ...
    const checkAllSelected = (expectedValue) => {
        const proceduresPath = `referenceDetails.responses[${formIndex}].data.administrativeAndEducationalAbilities`;
                ...
                responses: prevForm?.referenceDetails?.responses?.map((form, idx) => {
                    if (form?.schemaId === prevForm?.referenceDetails?.responses?.[formIndex]?.schemaId) {
                        ...
                        return {
                            ...
                            data: {
                                ...form.data,
                                administrativeAndEducationalAbilities: updatedProcedures,
                            },
                        };
                    }
    ...
    return (
        <div>
            <div className={style.applicantInfoCard}>
                ...
                {formSchema !== undefined && "administrativeAndEducationalAbilities" in formSchema?.properties && (
                    <ApplicationFieldCard
                        object={formSchema?.properties?.administrativeAndEducationalAbilities}
                ...
                <>
                    {formSchema !== undefined && "unsatisfactoryExplanation" in formSchema?.properties && (
                        <ApplicationFieldCard
                            ...
                            refGridStyle={style.gridStyle}
                            refRadioGridStyle={style.radioGridStyle}
                            gridStyle={style.fieldGridStyle}
...
export default AdministrativeAndEducationalAbilities;