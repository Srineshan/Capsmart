...
const BackgroundInformation = ({ referenceForm, setReferenceForm, applicationId, getReferenceDetails, formSchema, formIndex, formSchemaWholeObject, getAllPath, getAllLabels }) => {
    ...
    return (
        <div>
            {formSchema !== undefined && "backgroundInformation" in formSchema?.properties && (
                <ApplicationFieldCard
                    object={formSchema?.properties?.backgroundInformation}
