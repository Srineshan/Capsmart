...
const ProofOfDocumentationByEntity = () => {
  const [showPodTypeForHealthcareDialog, setShowPodTypeForHealthcareDialog] =
    useState(false);
          ...
          <div>
            <div className={`${style.displayInRow} ${style.marginTop10}`}>
              ...
              <div className={style.crossStyle}>
                ...
                <img
                  src={AddNewEntity}
                  onClick={() => getPodTypeForHealthcareDialog(true)}
                  className={`${style.colorFileStyle} ${style.marginLeft20}`}
                />
                <Icon
                  icon="cross"
                  size={25}
                  className={`${style.marginLeft20} ${style.marginBottom5} ${style.crossColor}`}
                />
