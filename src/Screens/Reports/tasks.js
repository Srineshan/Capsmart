        ...
        <div className={style.margin20}>
            <div className={style.bigCardGrid}>
                ...
                <div className={style.bigCardStyle}>
                    ...
                    <div className={`${style.margin20} ${style.spaceBetween} ${style.borderBottomStyle}`}>
                        <div className={`${style.taskTabWidth} ${style.selectedTab}`}>
                            <div className={style.spaceBetween}>
                                <div className={style.displayInRow}>
                                    <img src={ToDoReport} alt="todo" className={style.iconStyle} />
                        ...
                        <div className={`${style.taskTabWidth}`}>
                            <div className={style.spaceBetween}>
                                <div className={style.displayInRow}>
                                    <img src={Request} alt="req" className={style.iconRequestStyle} />
                                </div>
                                <div className={style.taskCountStyle}>20</div>
                            </div>
                        </div>
                        <div className={`${style.taskTabWidth}`}>
                            <div className={style.spaceBetween}>
                                <div className={style.displayInRow}>
                                    <img src={Envelope} alt="envelope" className={style.iconStyle} />
                    ...
                    <p className={`${style.taskFontStyle} ${style.marginLeft40}`}>Today</p>
                    <div className={style.borderStyle}></div>
                    <div className={style.marginLeft20}>
                        <div className={style.taskTableGrid}>
                            <div className={style.displayInRow}>
                                <p className={style.headingStyle}>Status</p>
                                <Icon icon="info-sign" color="#8A8C8D" className={`${style.marginLeft10} ${style.marginTop3}`} size={12} />
                            </div>
                            <div className={style.displayInRow}>
                        ...
                        <div className={style.scrollStyle}>
                            <div className={`${style.taskTableGrid} ${style.marginTop20}`}>
                                <div className={`${style.statusStyle} ${style.redCard}`}>Past Due</div>
                                <div className={style.tableDataFontStyle}>Abhi Gholap, DO</div>
                                <div className={style.tableDataFontStyle}>PAMF Provider Timesheet</div>
                                <div className={style.tableDataFontStyle}>Jan 1 - Jan 31</div>
                                <div className={style.tableDataFontStyle}>Timesheet Submitted</div>
                                <div>
                                ...
                                <div className={`${style.reviewStyle} ${style.blueCard}`}>Review</div>
                                <div className={style.tableDataFontStyle}>18:30</div>
                            </div>
                            <div className={style.borderStyleWithOutMargin}></div>
                            <div className={`${style.taskTableGrid} ${style.marginTop20}`}>
                                <div className={`${style.statusStyle} ${style.blueCard}`}>Past Due</div>
                                <div className={style.tableDataFontStyle}>Martin Tindale, MD</div>
                                <div className={style.tableDataFontStyle}>PAMF Provider Timesheet</div>
                                <div className={style.tableDataFontStyle}>Jan 1 - Jan 31</div>
                                <div className={style.tableDataFontStyle}>Timesheet Submitted</div>
                                <div>
                            ...
                            <div className={`${style.taskTableGrid} ${style.marginTop20}`}>
                                ...
                                <div className={`${style.reviewStyle} ${style.yellowCard}`}>Review</div>
                                <div className={style.tableDataFontStyle}>18:30</div>
                            </div>
                            <div className={style.borderStyleWithOutMargin}></div>
                            <div className={`${style.taskTableGrid} ${style.marginTop20}`}>
                                <div className={`${style.statusStyle} ${style.yellowCard}`}>Past Due</div>
